...
My focus is practical support skills: Active Directory administration, DNS, Group Policy, remote support, ticket-based troubleshooting, and structured documentation.
...
- Domain join & user provisioning
- RDP configuration & security controls
